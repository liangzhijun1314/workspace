    ...
    QWidget(parent)
{
    ...
    layout->addWidget(new QLabel(QString::fromLocal8Bit("已下载：")));
    ...
    layout->addWidget(new QLabel(QString::fromLocal8Bit("总大小：")));
    totalLabel = new QLabel("0 B");
    layout->addWidget(totalLabel);
    layout->addSpacerItem(new QSpacerItem(20,2,QSizePolicy::Preferred,QSizePolicy::Minimum));

    layout->addWidget(new QLabel(QString::fromLocal8Bit("速度：")));
