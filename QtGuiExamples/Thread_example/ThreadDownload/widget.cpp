...
void Widget::initWidget()
{
    ...
    fileName = new QLabel(QString::fromLocal8Bit("未知"));
    mainLayout->addWidget(fileName);
    errorLabel = new QLabel(QString::fromLocal8Bit("一切正常"));
    mainLayout->addWidget(errorLabel);

    QHBoxLayout *layout = new QHBoxLayout;
    layout->addWidget(new QLabel(QString::fromLocal8Bit("线程数：")));
    ...
    layout->addWidget(new QLabel(QString::fromLocal8Bit("正在运行的线程数：")));
    ...
    pauseBtn->setText(QString::fromLocal8Bit("暂停"));
    restartBtn->setText(QString::fromLocal8Bit("继续"));
    stopBtn->setText(QString::fromLocal8Bit("停止"));
...
void Widget::finishedSlot(int index)
{
    ...
    if(index == 0 && control->getState() == DownloadControl::Finished)
    {
        ...
        restartBtn->setEnabled(false);
        stopBtn->setEnabled(false);
        QMessageBox::information(this,title,QString::fromLocal8Bit("下载已完成"));
    }
}
...
{
    errorLabel->setText(QString::fromLocal8Bit("来自 ： ") + QString::number(index) + " \n" + errorString);
}
