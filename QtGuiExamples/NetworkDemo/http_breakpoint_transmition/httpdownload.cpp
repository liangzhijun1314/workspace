...
void HttpDownload::on_pButtonStart_clicked()
{
    // 从界面获取下载链接;
    ...
    m_downloadManager->setDownInto(true); //设置是否支持断点续传
    m_downloadManager->downloadFile(m_url, "E:\Qt5_Demo\NetworkDemo\http_breakpoint_transmition.rar");
//    m_timeRecord.start();
    m_timeInterval = 0;
    ui->labelStatus->setText(QString::fromLocal8Bit("正在下载"));
}

void HttpDownload::on_pButtonStop_clicked()
{
...
void HttpDownload::on_pButtonClose_clicked()
{
