...
void ShowDateTime::SetTimeInfo()
{
    ...
    this->labLive->setText(QString::fromLocal8Bit("已运行: %1天%2时%3分%4秒").arg(day).arg(hour).arg(minute).arg(seconds));
    this->labDateTime->setText(now.toString(QString::fromLocal8Bit("当前时间: yyyy年MM月dd日 HH:mm:ss")));
