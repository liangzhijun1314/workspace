...
{
    ui->setupUi(this);
    ui->sizeTypeComboBox->addItem(tr("OriginalSize 原始大小"), (int)ImageViewer::OriginalSize);
    ui->sizeTypeComboBox->addItem(tr("SuitableSize 适合大小"), (int)ImageViewer::SuitableSize);
    ui->sizeTypeComboBox->addItem(tr("FillSize 填充大小"), (int)ImageViewer::FillSize);
